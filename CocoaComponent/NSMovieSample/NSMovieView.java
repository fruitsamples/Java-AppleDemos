...
public class NSMovieView extends CocoaComponent {
    ...
    public static void main(String args[]) {
        ...
        mediaChoice.add(new MediaItem("","<please choose media>"));
        mediaChoice.add(new MediaItem("http://65.86.59.125/audio/mp3/Cappacino%2010.mp3", "Cappacino MP3 from Freeplay Music, Inc."));
        mediaChoice.add(new MediaItem("http://stream.qtv.apple.com/channels/npr/sprites/nprlive.mov", "NPR Live Stream"));
        ...
        mediaChoice.add(new MediaItem("http://65.86.59.125/audio/mp3/Far%20Away%2010.mp3", "Far Away MP3 from Freeplay Music, Inc."));
        mediaChoice.add(new MediaItem("file:///Developer/Examples/Java/QTJava/QTJavaDemos/media/jumps.mov", "QuickTime Sample Movie \"Jumps\""));
        mediaChoice.add(new MediaItem("file:///Developer/Examples/Java/QTJava/QTJavaDemos/media/sound.aif", "QuickTime Sample AIF \"sound.aif\""));
        mediaChoice.add(new MediaItem("file:///Developer/Examples/Java/QTJava/QTJavaDemos/media/TextOnly.mov", "QuickTime Sample Text Only"));
        ...
        controlPanel.add(mediaChoice, BorderLayout.CENTER);
        ...
        Button stopButton = new Button("Stop Media");
        ...
        Label statusField = new Label("          - Select media and then press play -          ");
        statusField.setFont(new Font("Helvetica", Font.ITALIC, 12));
        f.add(statusField);
